...
------------------------------------------------------------------------------
--- CUSTOM definitions
--- Each modified part is denoted by "CUSTOM"
------------------------------------------------------------------------------

--- Setup tags and hotkeys
--- web and notes use run or raise instead of basic hotkey)
local my_tags = {
	[1] = { name = "web", hotkey = "u", layout = awful.layout.suit.tile },
...
local my_apps = {
	firefox = { group = "apps", description = "run or raise firefox", hotkey = "u" },
	obsidian = { group = "apps", description = "run or raise obsidian", hotkey = "y" },
}
...
awful.screen.connect_for_each_screen(function(s)
	...
	--- CUSTOM tags
	------------------------------------------------------------------------------
	for _, tag_def in ipairs(my_tags) do
...
-- CUSTOM run or raise hotkeys
for name, app in pairs(my_apps) do
	globalkeys = gears.table.join(
		globalkeys,
		awful.key({ modkey }, app.hotkey, function()
...
-- CUSTOM tag hotkey loop
for i, tag_def in pairs(my_tags) do
	globalkeys = gears.table.join(
		globalkeys,
		------------------------------------------------------------------------------
		-- View tag only.
...
-- CUSTOM add rules
for _, details in pairs(my_rules) do
	table.insert(awful.rules.rules, {
		rule = { class = details.class },
		properties = {
			tag = details.tag,
			switchtotag = true,
			floating = false,
